...
EXTERN int TIMES_A;
EXTERN int TIMES_B;
#define TIMES_A_INIT 3 
#define TIMES_B_INIT 1
 
EXTERN int PROC_SCHED_COUNTER;

EXTERN int PROC_GROUP_INIT;
#define GROUP_A 0
#define GROUP_B 1

EXTERN int PROC_GROUP_INIT_COUNTER;
#define PROC_GROUP_INIT_A_COUNT 3
#define PROC_GROUP_INIT_B_COUNT 1
