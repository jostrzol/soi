...
#	define SYS_VCOPY     14	/* fnc code for sys_vcopy(src_proc, dest_proc, vcopy_s, vcopy_ptr) */
...
#	define SYS_FINDPROC  21	/* fcn code for sys_findproc(name, &task_nr, flags) */
/* MODIFIED START */
#   define SYS_SETPERCENTA 22
#   define SYS_SETGROUP 23
#   define SYS_GETGROUP 24
/* MODIFIED END */
